...
const menu = document.querySelector(".slidingMenu");
...
if (localStorage.getItem("dark-mode") == "true") {
  ...
  ham.style.filter = 'invert(0)';
  menu.style.background = '#1c2020';
...
toggle.addEventListener("click", function (e) {
  ...
  if (nextIcon === "sun") {
    ...
    menu.style.background = 'radial-gradient(#fff, rgb(255, 191, 191))';
    ham.style.filter = 'invert(1)';
